...
import pSteem from 'src/plugins/steem'

import pVuelidate from 'src/plugins/vuelidate'

import pDb from 'src/plugins/db'
...
import pFirebaseindex from 'src/plugins/firebase/index'
...
;[pSteem,pVuelidate,pDb,pI18n,pAxios,pVuexroutersync,pBootstrap,pFirebaseindex].forEach(plugin => {
  plugin({
    app,
    router,
    store,
